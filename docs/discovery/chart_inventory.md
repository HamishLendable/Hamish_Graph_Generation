...
| 12 | `bev_vs_rob_2x2_with_gap` | R | 2×2 — left col 3-line (segment A / segment B / mix-adjusted B); right col bar (raw gap pp) + line (mix-adjusted gap pp) | month × {a, b, adjusted, gap} | Two-segment compare with mix adjustment |
